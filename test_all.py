...
if not os.path.isdir('./test_results_caseall_mask'):
    os.mkdir('./test_results_caseall_mask')
...
for k in range(1, 30):
    ...
    war_path = '/home/chloe/all_warp/warp' + str(k) + '/'
    ...
    for i in range(len(war_list)):
        ...
        save_image(pic, './test_results_caseall_mask/image_{}_{}.jpg'.format(k, i+1))
