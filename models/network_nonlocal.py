...
class generator(nn.Module):
    ...
    def __init__(self, d=64):
        ...
        self.deconv6_seg = nn.ConvTranspose2d(d, 1, 4, 2, 1)
    ...
    def forward(self, input):
        ...
        e6_res3 = self.non_local_512(e6_res3)
        e6_res4 = self.res_block(e6_res3)
        e6_res5 = self.res_block(e6_res4)
        e6_res6 = self.res_block(e6_res5)
        e6_nonlocal = self.non_local_512(e6_res6)
...
class discriminator_snIns(nn.Module):
    ...
    def __init__(self, d=64):
        ...
        #self.conv7 = SpectralNorm(nn.Conv2d(d * 4, d * 4, 4, 2, 1))
