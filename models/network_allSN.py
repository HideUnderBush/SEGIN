...
class generator(nn.Module):
    ...
    def __init__(self, d=64):
        ...
        # Unet encoder
        self.conv1 = SNConv2d(7, d, 4, 2, 1)
        self.conv2 = SNConv2d(d, d * 2, 4, 2, 1)
        self.conv2_bn = nn.BatchNorm2d(d * 2)
        self.conv3 = SNConv2d(d * 2, d * 4, 4, 2, 1)
        self.conv3_bn = nn.BatchNorm2d(d * 4)
        self.conv4 = SNConv2d(d * 4, d * 8, 4, 2, 1)
        self.conv4_bn = nn.BatchNorm2d(d * 8)
        self.conv5 = SNConv2d(d * 8, d * 8, 4, 2, 1)
        self.conv5_bn = nn.BatchNorm2d(d * 8)
        self.conv6 = SNConv2d(d * 8, d * 8, 4, 2, 1)
        self.conv6_bn = nn.BatchNorm2d(d * 8)
        self.conv7 = SNConv2d(d * 8, d * 8, 4, 2, 1)
        self.conv7_bn = nn.BatchNorm2d(d * 8)
        self.conv8 = SNConv2d(d * 8, d * 8, 4, 2, 1)
        ...
        self.upconv1 = SNConv2d(d * 8, d * 8, 3, 1, 0)
        self.deconv1_bn = nn.BatchNorm2d(d * 8)
        self.upconv2 = SNConv2d(d * 8 * 2, d * 8, 3, 1, 0)
        self.deconv2_bn = nn.BatchNorm2d(d * 8)
        self.upconv3 = SNConv2d(d * 8 * 2, d * 8, 3, 1, 0)
        self.deconv3_bn = nn.BatchNorm2d(d * 8)
        self.upconv4 = SNConv2d(d * 8 * 2, d * 4, 3, 1, 0)
        self.deconv4_bn = nn.BatchNorm2d(d * 4)
        self.upconv5 = SNConv2d(d * 4 * 2, d * 4, 3, 1, 0)
        self.deconv5_bn = nn.BatchNorm2d(d * 4)
        self.upconv6 = SNConv2d(d * 4 * 2, d * 2, 3, 1, 0)
        self.deconv6_bn = nn.BatchNorm2d(d * 2)
        self.upconv7 = SNConv2d(d * 2 * 2, d, 3, 1, 0)
        self.deconv7_bn = nn.BatchNorm2d(d)
        self.upconv8 = SNConv2d(d * 2, 3, 3, 1, 0)
    ...
    def forward(self, input):
        ...
        #e6_res6 = self.res_block(e6_res4)
        e6 = e6_res5
