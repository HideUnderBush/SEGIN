...
class generator(nn.Module):
    ...
    def forward(self, input):
        ...
        d1 = self.deconv1_bn(self.upconv1(F.relu(e6)))
        ...
        d2 = self.deconv2_bn(self.upconv2(F.relu(d1)))
        ...
        d3 = self.deconv3_bn(self.upconv3(self.up(F.relu(d2))))
...
class discriminator_snIns(nn.Module):
    ...
    def __init__(self, d=64):
        ...
        #self.fc = SpectralNorm(nn.Linear(3 * 3 * d * 8, 1)) # failed this test
